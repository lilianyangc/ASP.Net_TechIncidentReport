                ...
                <form id="form1" runat="server">
                    LOGIN<table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td>
                                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter a password" ControlToValidate="txtPassword" ForeColor="Red" ValidationGroup="vg">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
